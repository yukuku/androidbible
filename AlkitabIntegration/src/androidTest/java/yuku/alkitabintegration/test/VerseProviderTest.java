...
public class VerseProviderTest {
    ...
    public void testAvailable() {
        assertEquals(ConnectionResult.SUCCESS, AlkitabIntegrationUtil.isIntegrationAvailable(InstrumentationRegistry.getInstrumentation().getTargetContext()));
    }
