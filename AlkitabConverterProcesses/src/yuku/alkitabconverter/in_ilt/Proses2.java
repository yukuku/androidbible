package yuku.alkitabconverter.in_ilt;
...
public class Proses2 {
	...
	public static String INPUT_BOOK_NAMES = "../../../bahan-alkitab/in-ilt/book_names.txt";
	static String INPUT_TEXT_2 = "../../../bahan-alkitab/in-ilt/ILT.xml";
	static String OUTPUT_YET = "../../../bahan-alkitab/in-ilt/in-ilt.yet";
	static String INFO_LOCALE = "in";
	static String INFO_SHORT_NAME = "ILT";
	static String INFO_LONG_NAME = "Indonesian Literal Translation";
	static String INFO_DESCRIPTION = "Kitab Suci Indonesian Literal Translation (KS-ILT) by Yayasan Lentera Bangsa (www.yalensa.com)";
	static boolean AUTOMATIC_TEXT_WITHOUT_PARAGRAPHS = true; // true if we consider text outside paragraph as Bible text as well.
	...
	public void u() throws Exception {
		{
			final String file = INPUT_TEXT_2;
	...
	public class Handler extends DefaultHandler2 {
		...
		private void tulis(String chars) {
			if (kitab_0 == -1) throw new RuntimeException("kitab_0 not initialized");
