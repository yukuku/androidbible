...
public class StepPagerStrip extends View {
    ...
    public StepPagerStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabWidth = res.getDimensionPixelSize(R.dimen.alkitabfeedback_step_pager_tab_width);
        mTabHeight = res.getDimensionPixelSize(R.dimen.alkitabfeedback_step_pager_tab_height);
        mTabSpacing = res.getDimensionPixelSize(R.dimen.alkitabfeedback_step_pager_tab_spacing);

        mPrevTabPaint = new Paint();
        mPrevTabPaint.setColor(res.getColor(R.color.alkitabfeedback_step_pager_previous_tab_color));

        mSelectedTabPaint = new Paint();
        mSelectedTabPaint.setColor(res.getColor(R.color.alkitabfeedback_step_pager_selected_tab_color));

        mSelectedLastTabPaint = new Paint();
        mSelectedLastTabPaint.setColor(res.getColor(R.color.alkitabfeedback_step_pager_selected_last_tab_color));

        mNextTabPaint = new Paint();
        mNextTabPaint.setColor(res.getColor(R.color.alkitabfeedback_step_pager_next_tab_color));
    }
