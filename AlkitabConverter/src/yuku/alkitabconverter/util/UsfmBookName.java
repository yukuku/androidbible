...
public class UsfmBookName {
	...
	static String[] ntBookNames = "MAT MRK LUK JHN ACT ROM 1CO 2CO GAL EPH PHP COL 1TH 2TH 1TI 2TI PHM TIT HEB JAS 1PE 2PE 1JN 2JN 3JN JUD REV".split(" ");
	
	public static int toKitab0(String name) {
