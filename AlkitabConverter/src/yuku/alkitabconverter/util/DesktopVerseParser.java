...
public class DesktopVerseParser {
	...
	static String[] orderedBooks = {
		...
		"zakharia|za|zechariah|zech|zec|za",
		...
		"wahyu|why|revelations|revelation|rev|re|rv",
	};
