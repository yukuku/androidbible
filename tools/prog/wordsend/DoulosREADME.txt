...
Please read the documentation (DoulosSIL4FontDocumentation.pdf) to see 
...
Doulos SIL FAQ (http://scripts.sil.org/DoulosSILfontFAQ).
...
(http://scripts.sil.org/DoulosSIL_AdLvSup).
...
Appearance and Themes, then look in the upper left). Then drag the font
file (DoulosSILR.ttf) into the window - or choose File, Install New Font..., 
