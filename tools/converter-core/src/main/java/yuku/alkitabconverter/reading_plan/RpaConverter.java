...
public class RpaConverter {
	...
	private final static String FILE_INPUT = System.getProperty("user.dir") + "/reading-plans/sources/" + FILE_NAME + ".txt";
	private final static String FILE_OUTPUT = System.getProperty("user.dir") + "/reading-plans/sources/" + FILE_NAME + ".rpa";
