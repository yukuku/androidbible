...
@Parameters(commandNames = "yet2internal", commandDescription = "Convert a .yet file to the built-in version format that ships inside the APK")
public class YetToInternal implements Command {
	@Parameter(description = "<yet-file> [<internal-files-dir>]")
	...
	private int convert() throws Exception {
		if (params.size() < 1) {
