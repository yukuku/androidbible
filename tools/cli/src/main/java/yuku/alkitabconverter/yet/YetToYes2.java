...
@Parameters(commandNames = "yet2yes", commandDescription = "Convert a .yet file to a .yes file")
public class YetToYes2 implements Command {
	@Parameter(description = "<yet-file> [<yes-file>]")
