 ...
 * for every {@code Log} method, which breaks any production code in AlkitabYes2 that logs
 * directly (e.g. {@link yuku.alkitab.yes2.Yes2Reader}, {@link yuku.alkitab.yes2.model.SectionIndex},
 * the xref/footnote sections). This file provides real no-op implementations visible only on
 * the unit-test classpath. The shape matches the Android SDK's {@code Log} so production code
 * behaves identically.
 */
public class Log {
