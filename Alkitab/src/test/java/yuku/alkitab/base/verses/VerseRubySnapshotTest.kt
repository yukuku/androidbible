...
class VerseRubySnapshotTest {
    ...
    /** Strong's numbers for words the translation does not have, written with no base of their own between a bracket pair. */
    private val EMPTY_BASE = "@@@<rs=H2585@>Henokh@/ @<rs=H3205@>lahir@/ baginya. [@<rs=H834 H8141 0@>@/]"

    /** A two-word base run straddles a line break, so its reading has to go somewhere. */
    private val SPLIT_BASE_RUN = "@@@<rs=H3117@>Jadi, masa hidup@/ @<rs=H3382@>Yared@/ @<rs=H8147 H8346 H8141 H8672 H3967@>adalah 962@/ @<rs=H8141@>tahun@/, @<rs=H4191@>kemudian dia mati@/."
    ...
    private val groups: Map<String, List<Sample>> = linkedMapOf(
        "basics" to listOf(
            ...
            Sample("base run split by a line break", SPLIT_BASE_RUN),
            Sample("reading with no base of its own", EMPTY_BASE),
