...
public class DailyVerseAppWidgetReceiver extends AppWidgetProvider {
    public static void buildUpdate(final Context context, final int appWidgetId) {
        ...
        rv.setPendingIntentTemplate(R.id.lsItems, PendingIntent.getBroadcast(context, appWidgetId * 10 + 2, generalIntent, PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_IMMUTABLE));
    ...
    public static void setAlarm(Context context, int[] ids) {
        ...
        final PendingIntent pi = PendingIntent.getBroadcast(context, 0, intent, PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_IMMUTABLE);
