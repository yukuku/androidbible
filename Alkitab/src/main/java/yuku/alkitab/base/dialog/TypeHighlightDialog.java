...
public class TypeHighlightDialog {
     ...
     */
    public TypeHighlightDialog(Context context, int ari, Listener listener, int defaultColorRgb, @Nullable Highlights.Info info, String title, @Nullable final CharSequence verseText) {
     ...
     */
    public TypeHighlightDialog(final Context context, int ari_bookchapter, IntArrayList selectedVerses, Listener listener, final int defaultColorRgb, String title) {
        this(context, ari_bookchapter, selectedVerses, listener, defaultColorRgb, null, title, null);
    }

    private TypeHighlightDialog(final Context context, int ari_bookchapter, IntArrayList selectedVerses, Listener listener, final int defaultColorRgb, @Nullable final Highlights.Info info, String title, @Nullable final CharSequence verseText) {
