...
public class ReadingPlanActivity extends BaseLeftDrawerActivity implements LeftDrawer.ReadingPlan.Listener {
        ...
        bToday.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                popupMenu.setOnMenuItemClickListener(menuItem -> {
                    ...
                    switch (itemId) {
                        case 1 -> showCalendar();
                        case 2 -> gotoFirstUnread();
                        case 3 -> gotoToday();
                        case 4 -> showSetStartDateDialog();
                        case 5 -> catchMeUp();
                    }
                    return true;
                });
        ...
        Background.run(() -> {
            try {
                ...
                Foreground.run(() -> {
                    ...
                    if (id == 0) {
                        MaterialDialogJavaHelper.showOkDialog(ReadingPlanActivity.this, getString(R.string.rp_download_reading_plan_data_corrupted));
                        return;
                    }
                ...
                if (!cancelled.get()) {
                    ...
                    Foreground.run(() -> MaterialDialogJavaHelper.showOkDialog(ReadingPlanActivity.this, getString(R.string.rp_download_reading_plan_failed)));
                }
            } finally {
                pd.dismiss();
            }
    ...
    void one_reading_longClick(final int day, final int sequence) {
        MaterialDialogJavaHelper.showOkDialog(
            this,
            getString(R.string.rp_mark_as_read_up_to),
            getString(R.string.ok),
            () -> {
